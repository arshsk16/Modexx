...
// Team member data (single owner profile)
const teamMembers = [
  {
    id: 1,
    name: 'Mohammad Arshad Ali',
    role: 'Developer & Founder',
    description:
      'Building  with a focus on reliability, usability, and real impact for patients and providers.',
        ...
        <VisionMissionContainer>
          ...
          <Box dark={dark}>
            ...
            <MissionText dark={dark} className="font-sans">
              ...
              innovation, we work to ensure that the Modex Health Care platform
              evolves to meet the changing needs of the healthcare industry.
            </MissionText>
          </Box>
        </VisionMissionContainer>

        <Title dark={dark}>Meet the Developer</Title>
        <TeamGrid>
