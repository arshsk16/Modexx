...
const HospitalsAround = () => {
  ...
  const showRouteToHospital = (hospital) => {
    ...
    // Disable OSRM demo routing to avoid CORS/uptime errors
    console.warn(
      'Routing is disabled in this demo build. Please configure a paid routing provider (Mapbox, OpenRouteService, GraphHopper) or a self-hosted OSRM and set its serviceUrl.'
    );
    alert(
      'Route drawing is disabled in this demo. Please enable a routing provider in HospitalsAround.jsx.'
    );
  };
